...
export default async function ShowDetailsPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main className="relative min-h-screen text-white flex items-start justify-center pt-32">
      {/* Фон */}
      <div
      ...
      <div className="relative z-10 w-full max-w-4xl px-6">
        {/* Заголовок */}
        <h1 className="text-5xl font-bold text-center mb-10 drop-shadow-xl">
          {show.title}
        </h1>

        {/* Опис */}
        <p className="text-lg leading-relaxed text-center max-w-3xl mx-auto mb-12 drop-shadow-lg">
          {show.description}
        </p>
    ...
    <p>
      <b>Зала:</b> {show.hall.name} 
        ...
        <a
          ...
          className="block mt-12 mx-auto bg-red-600 hover:bg-red-700 text-white text-center py-4 px-10 rounded-2xl font-semibold shadow-xl transition w-fit"
        >
          Забронювати місцe
        </a>
      </div>
